...
typedef enum _CEETokenID {
    ...
    kCEETokenID_IB_OUTLET,
    kCEETokenID_IB_ACTION,
    ...
    kCEETokenID_ARGUMENTS,
    kCEETokenID_EXP,
    kCEETokenID_EXP_ASSIGNMENT,
    kCEETokenID_DEBUGGER,
    kCEETokenID_EVAL,
    kCEETokenID_FUNCTION,
    kCEETokenID_ZERO_FILL_LEFT_SHIFT,
    kCEETokenID_SIGNED_RIGHT_SHIFT,
    kCEETokenID_ZERO_FILL_RIGHT_SHIFT,
    kCEETokenID_ZERO_FILL_LEFT_SHIFT_ASSIGNMENT,
    kCEETokenID_SIGNED_RIGHT_SHIFT_ASSIGNMENT,
